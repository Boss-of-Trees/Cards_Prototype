...
import ExternalLibraries.org.sqlite.SQLiteConnection;
import ExternalLibraries.org.sqlite.core.CoreStatement;
import ExternalLibraries.org.sqlite.jdbc3.JDBC3DatabaseMetaData.ImportedKeyFinder.ForeignKey;
import ExternalLibraries.org.sqlite.util.StringUtils;

public abstract class JDBC3DatabaseMetaData extends ExternalLibraries.org.sqlite.core.CoreDatabaseMetaData {
    ...
    /**
     * @see DatabaseMetaData#getCrossReference(String, String,
            ...
            for (String tbl : tableList) {
                try {
                    ...
                    for (Iterator iterator = fkNames.iterator(); iterator.hasNext(); ) {
                        ImportedKeyFinder.ForeignKey foreignKey = (ImportedKeyFinder.ForeignKey) iterator.next();
